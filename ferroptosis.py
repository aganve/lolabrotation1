...
Monomer('GSH', ['b1GPX4','state'], {'state': ['red', 'ox']})
Monomer('GPX4', ['b1GSH', 'b2Peroxide', 'state'], {'state': ['i', 'a']})
Monomer('Liperox', ['b2GPX4', 'state'], {'state': ['ox', 'red']})
...
catalyze(CR(bCys2=None) ** Cyto, Cys2(bCR=None) ** Cyto, Cys(bGCL=None) ** Cyto, kf2, kr2, kc2)
...
catalyze(GCL(bCys=None) ** Cyto, Cys(bGCL=None) ** Cyto, GlutCys(bGSS=None) ** Cyto, kf3, kr3, kc3)
...
catalyze(GSS(bGlutCys=None) ** Cyto, GlutCys(bGSS=None) ** Cyto, GSH(b1GPX4=None, state='ox') ** Cyto, kf4, kr4, kc4)
...
Observable('Cys_obs', Cys(b=None) ** Cyto)
Observable('GCL_obs', GCL(bCys=None) ** Cyto)
Observable('Glut_Cys_obs', GlutCys(b=None) ** Cyto)
Observable('GSS_obs', GSS(bGlutCys=None) ** Cyto)
Observable('GSH_unbound_ox_obs', GSH(b1GPX4=None, state='ox') ** Cyto)
Observable('GSH_unbound_red_obs', GSH(b1GPX4=None, state='red'))
Observable('GPX4_GSH_unbound_inactive_obs', GPX4(b1GSH=None, b2Liperox=None, state='i') ** Cyto)
Observable('GPX4_GSH_bound_active_obs', GSH(b1GPX4=1, state='ox') ** Cyto % GPX4(b1GSH=1, b2Liperox=None, state='a') ** Cyto)
Observable('Liperox_unbound_ox_obs', Liperox(b2GPX4=None, state='ox') ** Cyto)
Observable('Liperox_unbound_red_obs', Liperox(b2GPX4=None, state='red') ** Cyto)
Observable('GPX4_GSH_Liperox_complex_obs', GSH(b1GPX4=1, state='red') ** Cyto % GPX4(b1GSH=1, b2Liperox=1, state='a') ** Cyto % Liperox(b2GPX4=1, state='red') ** Cyto)
...
plt.figure()
plt.plot(tspan, result.observables['Liperox_unbound_red_obs'][:], lw = 1.5, label = 'Liperox (red) molecules') #plot observable
plt.xlabel('Time [min]', fontsize=14)
plt.ylabel('Amount of Liperox (red) produced [# of molecules]', fontsize=14)
plt.title('Liperox (red) molecules')
